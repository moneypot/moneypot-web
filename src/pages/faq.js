...
const WorkingsWallet = () => { 
  ...
  <p> What moneypot does offer, (that is, under the most ideal conditions) is unlinkeability within it's own ecosystem. What exactly does this mean, you ask? For that we first need to explore what exactly unlinkeability is, and how it's applied in this context. 
    </p>
